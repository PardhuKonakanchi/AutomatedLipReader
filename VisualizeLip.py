...
#Unified process of videoFrameConverter and mouthV3 for lip extraction from videos
...
locationOfInput = "C:\\Users\\test\\videos\\input\\aa.MTS"
locationOfOutput = "C:\\Users\\test\\videos\\output"
"""
...
# Dlib requirements.
predictor_path = 'C:\\Users\\Downloads\\shape_predictor_68_face_landmarks.dat'
detector = dlib.get_frontal_face_detector()
predictor = dlib.shape_predictor(predictor_path)
mouth_destination_path = os.path.dirname(locationOfOutput) + '/' + 'mouth'
if not os.path.exists(mouth_destination_path):
    os.makedirs(mouth_destination_path)

inputparameters = {}
outputparameters = {}
reader = skvideo.io.FFmpegReader(locationOfInput,
...
# Define the writer
writer = skvideo.io.FFmpegWriter(locationOfOutput)
...
the_filename = os.path.dirname(locationOfOutput) + '/' + 'activation'
my_list = activation
